...
function App() {
	...
	useEffect(() => {
		document.title = "NFT Collections Dapp";
		...
		if (metaDescription) {
			...
			newMetaDescription.content = "nft-collections-Dapp";
		...
		<div>
			<div className="main">
				<div>
					...
					<div className="description">
						It&#39;s a simple collection of NFTs for Blockchain developers.
					</div>
					<div className="description">{tokenIdsMinted}/20 have been minted</div>
					{renderButton()}
				</div>
				<div>
					<img className="image" src="./cryptodevs/0.svg" alt="" />
				</div>
			</div>
